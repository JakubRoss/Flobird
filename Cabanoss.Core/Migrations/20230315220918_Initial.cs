        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachment_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateTable(
                name: "boardUserTaskElements",
                columns: table => new
                {
                    BoardUserId = table.Column<int>(type: "int", nullable: false),
                    TaskElementId = table.Column<int>(type: "int", nullable: false),
                    BoardUserBoardId = table.Column<int>(type: "int", nullable: false),
                    BoardUserUserId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_boardUserTaskElements", x => new { x.BoardUserId, x.TaskElementId });
                    table.ForeignKey(
                        name: "FK_boardUserTaskElements_BoardsUser_BoardUserBoardId_BoardUserUserId",
                        columns: x => new { x.BoardUserBoardId, x.BoardUserUserId },
                        principalTable: "BoardsUser",
                        principalColumns: new[] { "BoardId", "UserId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_boardUserTaskElements_TaskElements_TaskElementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_boardUserTaskElements_BoardUserBoardId_BoardUserUserId",
                table: "boardUserTaskElements",
                columns: new[] { "BoardUserBoardId", "BoardUserUserId" });

            migrationBuilder.CreateIndex(
                name: "IX_boardUserTaskElements_TaskElementId",
                table: "boardUserTaskElements",
